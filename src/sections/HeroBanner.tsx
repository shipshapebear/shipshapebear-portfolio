...
const HeroBanner = ({ data }) => {
  return (
    <section id="home" className="w-full relative py-20">
      <GradientOverlay />
      <div className="max-w-screen-xl mx-auto">
        <div className="block w-full mx-auto h-full mt-[55px]">
          ...
          {/* <div className="grid grid-cols-1 md:grid-cols-3 px-4 gap-x-6 gap-y-4 mt-[50px] justify-center">
            {data.prismicHome.data.banner_widgets.map((val: any, i: number) => {
              return (
                <Link
                  to="/"
                  className="flex float-none bg-neutral-900/50 md:bg-transparent rounded-md items-center cursor-pointer p-2 lg:p-5"
